...
export function Footer() {
  return (
    <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex items-center lg:justify-between">
      <div className="hidden lg:flex lg:items-center lg:gap-3">
        <Image className="" src="/album.jpg" width={56} height={56} alt="Capa"/>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-zinc-500">00:31</span>
          <div className="h-1 rounded-full w-96 bg-zinc-600">
            <div className="h-1 rounded-full w-40 bg-zinc-200"></div>
          </div>
          <span className="text-xs text-zinc-500">02:14</span>
        </div>
      </div>
